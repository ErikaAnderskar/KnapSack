...
How much time does it take to run brute_force_knapsack with $16$ observations?
```{r KS1b}
...
It takes about `r sys_time[3]` milliseconds to run brute_force_knapsack with $16$ observations. 
...
How much time does it take to run knapsack_dynamic with $500$ observations?
```{r KS3}
...
It takes about `r sys_time[3]` milliseconds to run knapsack_dynamic with $500$ observations. 
...
When the C++ code is used, the function greedy_knapsack is about `r sys_time[3]` millisecounds faster. 
